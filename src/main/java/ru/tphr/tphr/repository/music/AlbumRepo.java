...
//    Album getAlbumWithSongs(@Param("id") long id);
    ...
    @Query("select new ru.tphr.tphr.DTO.LikesAlbumDto(a.id, a.header,a.fileName, a.releaseDate, a.songPreview, a.author.email, a.author.firstName, a.author.lastName, a.author.pathToAvatar, size(a.likes) , size(a.comments) , " +
