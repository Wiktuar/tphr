...
public class AllComposeDTO extends CompositionDTO{
    ...
    public AllComposeDTO(long id, String header, String fileName, String releaseDate, String email, String firstName, String lastName, String pathToAvatar, String textPreview, String linkPreview, int likes, int comments, Song song, int compType, boolean meLiked, long compAuthorID) {
        super(id, header, fileName, releaseDate, email, firstName, lastName, pathToAvatar, likes, comments, meLiked, compAuthorID);
        this.textPreview = textPreview;
        this.linkPreview = linkPreview;
        this.song = song;
        this.compType = compType;
